...
class Statmech(Base, TimestampMixin, CreatedByMixin):
    ...
    external_symmetry: Mapped[Optional[int]] = mapped_column(SmallInteger, nullable=True)
...
class StatmechTorsionDefinition(Base):
    ...
    __table_args__ = (
        CheckConstraint("coordinate_index >= 1", name="statmech_torsion_coord_index_ge_1"),
