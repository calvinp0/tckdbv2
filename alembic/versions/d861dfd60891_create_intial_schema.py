...
def upgrade() -> None:
    ...
    op.execute(
        """
               CREATE TYPE calc_quality AS ENUM ('raw',
                                              'curated',
                                              'rejected');
...
CREATE TABLE "calculation_output_geometry" (
  ...
  UNIQUE ("calculation_id", "geometry_id")
);"""
    )
    op.execute(
        """
...
def downgrade() -> None:
    ...
    op.execute("DROP TYPE IF EXISTS calc_quality;")
